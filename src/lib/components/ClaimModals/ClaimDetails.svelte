...
{:then claimData}
  <div>
    <div>
      <p class="text-left font-semibold text-xl pb-9">Claim Details:
        <span class="dark:text-purple-400 text-purple-700">{ID}</span>
      </p>
    </div>
    <!-- Policy Holder -->
    <Accordion>
      <span slot="head"
            class="font-semibold text-xl p-2 dark:text-purple-400 text-purple-700">Policy Holder Details</span>
      <div slot="details">
    ...
    <!-- Non Policy Holder -->
    {#if detailedClaim["customer"]["driverSelected"] === "2"}
      <Accordion>
        <span slot="head" class="font-semibold text-xl p-2 dark:text-purple-400 text-purple-700">Non Policy Holder Details</span>
        <div slot="details">
          <!-- FILL THIS OUT -->
          Non policy holder details
        </div>
      </Accordion>
    {/if}
    <!-- Driver History -->
    <Accordion>
      <span slot="head" class="font-semibold text-xl p-2 dark:text-purple-400 text-purple-700">Driver History</span>
      <div slot="details">
    ...
    <!-- Vehicle -->
    <Accordion>
      <span slot="head" class="font-semibold text-xl p-2 dark:text-purple-400 text-purple-700">Vehicle History</span>
      <div slot="details">
        <div class="flex flex-col gap-4 ">
          <div class="mx-auto">
            <img class="w-96" src={detailedImage.imageLink} alt="Vehicle" />
          </div>
          <div id="vehicleForm" class="flex flex-col flex-wrap gap-5">
            <div class="grid xl:grid-cols-2 xl:gap-6">
              <div class="relative z-0 w-full mb-6 group">
                <input
